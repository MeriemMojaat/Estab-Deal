...
$exchange =$exchangec->showDetails($_GET['idexchange']);
echo 'id: ' . $exchange['idexchange'];
?>
<?php
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <img class="d-block mx-auto mb-4 center" src="C:\Users\tcp\Desktop\SQL_New\htdocs\product\assets\img\logo.png" alt="" width="100" height="65">
    ...
    <br>
    <br>
<p> idexchange:  <?= $exchange['idexchange']; ?> </p> 
<p> iduser:  <?= $exchange['iduser']; ?> </p> 
<p> idproduct:  <?= $exchange['idproduct']; ?> </p>
<p> productname:  <?= $exchange['productname']; ?> </p>
<p> picture:  <?= $exchange['picture']; ?> </p>
