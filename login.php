...
if(isset($_POST['connect']))
{
   ...
   $liste=$clientC->getthemail($email);
   ...
   else
   {
    ...
    echo "alert('Email ot Password incorect');
      ...
      <h2>Sign in form</h2>      
            <form action="" class="login-form__form" method="post" enctype="multipart/form-data" >
                ...
                <div class="login-form__bottom">
                                <input class="thm-btn login-form__btn" type="submit" value="Sign In" name="connect" id="connect">
                </div>
                </form>
                <div class="login-form__bottom">
                            <a class="pull-right" href="ForgetPwd.php">(Forget password?)</a>
                </div>
