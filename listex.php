    ...
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <div class="container-fluid">
            ...
            <a class="nav-link" href="index1.php">Home </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="addex.php">ADD EXCHANGE </a>
                    </li>
                    <li class="nav-item">
    ...
    <table class="table">
        ...
        ?>
            <tr>
                ...
                <td> <?= $c['idproduct']; ?> </td>
                <td> <?= $c['productname']; ?> </td>
                <td> <img src="../assets/img/<?= $c['picture'] ?>"  width="200" height="200"> </td>
             
                <td> <a href="detailex.php ?idexchange=<?= $c['idexchange']; ?>"> View details</a> </td>
                <td> <a href="deleteex.php ?idexchange=<?= $c['idexchange']; ?>">Delete</a> </td>
                <td>

                    <form method="POST" action="updateex.php">
                        <input type="submit" name="update" value="update">
                        <input type="hidden" value=<?PHP echo $c['idexchange']; ?> name="id">
                    </form>
                </td>
