                ...
                <form action="" method="POST">
                    <table class="table" align="center">
                        <tr>
                            ...
                            <td><input type="text" name="id" id="id" value="<?php echo $product['id']; ?>" maxlength="20" readonly></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="points" id="points" value="<?php echo $product['points']; ?>" ></td>
                        </tr>
                        <tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="category" id="category" value="<?php echo $product['category']; ?>" ></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
