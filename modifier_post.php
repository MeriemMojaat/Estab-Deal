...
<?php
	...
	if (
		...
		if (
            ...
            $postC->modifierpost($user, $_GET['id_post']);
            header('refresh:5;url=afficher_post.php');
        }
        else
...
?>
			...
			if (isset($_GET['id_post'])){
				$user = $postC->recupererpost($_GET['id_post']);
                            ...
                            <form action="" style="border:2px solid #ccc" method="POST">
                                ...
                                Re-Write ID User:<br>
                                    ...
                                    <input type="text" name="topic" id="topic"
                                        value="<?php echo $user['topic']; ?>">
                                    <br>
                                    Picture:<br>
                                    <input type="file" name="picture_post" id="picture_post" value="<?php echo $user['picture_post']; ?>">
                                    <img id="blah" alt="your image" />
                                    <br>
                                    ID React:<br>
                                    <input type="text" name="id_react" id="id_react"
                                        value="<?php echo $user['id_react']; ?>">
                                    <br>
