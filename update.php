        ...
        <form action="" method="POST">
            <table class="table" align="center">
                <tr>
                    ...
                    <td><input type="number" name="idbasket" id="idbasket" value="<?php echo $basket['idbasket']; ?>" maxlength="20" readonly></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number" name="iduser" id="iduser" value="<?php echo $basket['iduser']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number" name="idproduct" id="idproduct" value="<?php echo $basket['idproduct']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                <td>
                ...
                <tr>
                    <td>
                        <label for="totp">Total Number of points:
                        </label>
                    </td>
                    <td><input type="int" name="totp" id="totp" value="<?php echo $basket['totp']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
