  ...
  <nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          <a class="nav-link" href="ajouter_post.php">NEW POST? </a>
        </li>
...
<input type="submit" name="submit" value="Search">
		...
		<table id="ejemplo" border=1 align = 'center' class="fixed_headers">
			<tr>
				<th><span style="color: #ff0000;">ID Post</span></th>
				<th><span style="color: #ff0000;">ID User</span></th>
				<th><span style="color: #ff0000;">First Name</span></th>
				<th><span style="color: #ff0000;">Date</span></th>
				<th><span style="color: #ff0000;">Topic</span></th>
				<th><span style="color: #ff0000;">Picture Post</span></th>
				<th><span style="color: #ff0000;">ID React</span></th>
				<th><span style="color: #ff0000;">Delete</span></th>
				<th><span style="color: #ff0000;">Update</span></th>
			</tr>
			...
			?>
				<tr>
					<td><strong><?PHP echo $user['id_post']; ?></strong></td>
					<td><?PHP echo $user['id_user']; ?></td>
					<td><?PHP echo $user['first_name']; ?></td>
					<td><?PHP echo $user['date']; ?></td>
					<td><?PHP echo $user['topic']; ?></td>
                    <td><img src="../assets/img/<?= $user['picture_post'] ?> "width = "200" height = "200"></td>
					<td><?PHP echo $user['id_react']; ?></td>
					<td>
						<form method="POST" action="supprimer_post.php">
						<input class="action-button shadow animate red" type="submit" name="Delete" value="Delete">
						<input type="hidden" value=<?PHP echo $user['id_post']; ?> name="id_post">
						</form>
					</td>
					<td>
						<a href="modifier_post.php?id_post=<?PHP echo $user['id_post']; ?>"
                        class="action-button shadow animate yellow"> Update </a>
					</td>
				</tr>
			<?PHP
				}
