    ...
    <tr>
        ...
        <td>
            <form method="POST" action="update.php">
                ...
                <input type="hidden" value=<?php echo $c['idbasket']; ?> name="idbasket">
            </form>
        </td>
        <td> <a href="detail.php ?idbasket=<?= $c['idbasket']; ?>"> View Details</a> </td>
        <td> <a href="delete.php ?idbasket=<?= $c['idbasket']; ?>">Delete</a> </td>
